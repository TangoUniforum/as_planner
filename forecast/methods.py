...
register(Method(
    ...
    blurb="The validated controller with the Global engine's L1 harvest "
          ...
          "gets you the plain controller. AND TURNING THE LEVERS ON MAKES IT "
          "WORSE, measured the same way across the same 21 PRs: empty harvest "
          "weeks per plan 4.6 -> 6.3, weeks under floor 25.0 -> 26.4, still 10 "
          "of 21 plans with an empty week; only the worst non-empty week "
          "improves (7,129 -> 7,467). Whoever set hybrid_purge_lever, "
          "hybrid_production_lever and sixn_level_drains to false was right on "
          "the current code. The 2026-08-03 figures below predate four changes "
          "(handling mortality per deposit, grade_efficiency, Thursday purge "
          "move-in, 6N one-batch-one-tank) and no longer reproduce. *** "
